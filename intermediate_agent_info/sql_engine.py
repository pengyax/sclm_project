...
def connect(type='new_ERP', echo=False):
    if type == 'new_ERP':
        engine = create_engine("mssql+pymssql://biuser:bierp@!123456@139.196.55.81/SCLMERPDB_UE", echo=echo)
		## ERP链接
    elif type=='biconfig':
        ...
        engine = create_engine("mssql+pymssql://biuser:bierp@!123456@192.168.128.10/shcm", echo=echo)
    elif type == 'wms':
